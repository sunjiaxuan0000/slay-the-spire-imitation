...
public class EventDef {
    ...
    /**
     * 事件背景大图的文件名（相对 {@code /com/example/demo/}）。
     *
     * <p>事件页现在<b>只有一张全屏背景大图</b>，没有「左侧小插图」那套了
     * （{@link EventView}）—— 每个事件都像猪雪峰一样，用一整张图铺满整个页面。</p>
     *
     * <p>为 null 时 {@link EventView} 退回通用的 {@code event_bg.png}。</p>
     */
